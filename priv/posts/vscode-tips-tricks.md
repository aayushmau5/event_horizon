...
> (card) Here's the [link](https://github.com/aayushmau5/dotfiles/tree/master/vscode) to the config file I use.
...
> (info) All the editor related settings have 'editor' prefix. For the list of editor specific configurations, start typing 'editor.' and vscode will give you all the hints ;)
...
> (card) You can access the keybindings configuration file by going to command palette(CTRL+SHIFT+P), and selecting "Open Keyboard Settings(JSON)".
