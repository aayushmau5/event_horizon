defmodule EventHorizonWeb.Components.SpotifyNowPlaying do
  @moduledoc """
  Component for displaying Spotify now playing status.
  """
  ...
  def spotify_now_playing(assigns) do
    ...
    >
      <.spotify_icon />
      <div class="text-sm">
        <.play_message now_playing={@now_playing} />
      </div>
    </a>
    """
  end

  defp play_message(%{now_playing: nil} = assigns) do
    ~H"""
    <div class="text-gray-400">Nothing playing at the moment</div>
    """
  end
  ...
  defp spotify_icon(assigns) do
    ~H"""
    <svg viewBox="0 0 2931 2931" class="w-9 h-9 flex-shrink-0">
      <path
        fill="#2ebd59"
