defmodule EventHorizonWeb.ClusterLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app current_path={@current_path} socket={@socket}>
        ...
        <p class="text-(--font-color)">This app is hosted on fly.io. I have two other elixir apps hosted on fly.io at different regions.</p>
        <p class="text-(--font-color)">fly.io provides private networking between apps cross-region. For fun, I clustered my app with the other two applications.</p>
        <p class="text-(--font-color)">What you see is the latency between these clusters along with your latency with this app ;)</p>
        ...
        <div class="rounded-xl p-6">
          <svg viewBox="0 0 400 420" class="w-full max-w-lg mx-auto">
            ...
            <text
              ...
              y="95"
              text-anchor="start"
              fill={client_latency_color(@client_rtt)}
              font-size="12"
            >
              {format_client_latency(@client_rtt)}
            </text>
            <%!-- EH → PHX --%>
            <line
              x1="230"
              ...
              marker-end="url(#arrowhead)"
            />
            <text x="280" y="235" text-anchor="middle" fill={latency_color(@latencies.eh_to_phx)} font-size="12">
            ...
            <line
              ...
              marker-end="url(#arrowhead)"
            />
            <text x="120" y="235" text-anchor="middle" fill={latency_color(@latencies.eh_to_bsh)} font-size="12">
              ...
              marker-end="url(#arrowhead)"
            />
            <text x="200" y="330" text-anchor="middle" fill={latency_color(@latencies.phx_to_bsh)} font-size="12">
  ...
  defp format_client_latency(nil), do: "—"
  defp format_client_latency(ms), do: "#{ms} ms"
  ...
  defp client_latency_color(nil), do: "#71717a"
  defp client_latency_color(ms) when ms < 50, do: "#22c55e"
  defp client_latency_color(ms) when ms < 150, do: "#eab308"
  defp client_latency_color(_), do: "#ef4444"
end
